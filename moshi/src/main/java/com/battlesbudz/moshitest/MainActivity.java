...
public final class MainActivity extends Activity {
    ...
    @Override public void onCreate(Bundle saved){
        ...
        TextView scope=new TextView(this);scope.setText("CPU / Vulkan voice benchmark • Fully local after setup\n\nMoshi / Moshika Q4_K experimental voice engine. Compare GPU precision runs CPU, current GPU and higher precision GPU using the existing recording and Mimi download. Allow several minutes. The reference model has a female voice. This does not yet test live conversation or echo cancellation.\n");column.addView(scope);
        ...
        button(column,"Play higher precision GPU result",()->play("fp32_encode_fp32_decode.pcm"));
        button(column,"Play CPU encoder → higher precision GPU",()->play("cpu_encode_fp32_decode.pcm"));
