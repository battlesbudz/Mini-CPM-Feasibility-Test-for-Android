...
public final class MainActivity extends Activity {
    ...
    @Override public void onCreate(Bundle saved){
        ...
        TextView scope=new TextView(this);scope.setText("CPU / Vulkan voice benchmark • Fully local after setup\n\nMoshi / Moshika Q4_K experimental voice engine. Compare CPU/GPU codec runs all four combinations automatically using the existing recording and Mimi download. Allow a few minutes. The reference model has a female voice. This does not yet test live conversation or echo cancellation.\n");column.addView(scope);
        ...
        voice=new Spinner(this);voice.setAdapter(new ArrayAdapter<>(this,android.R.layout.simple_spinner_dropdown_item,new String[]{"1. Mimi codec replay · 10 sec","2. Moshi load-only · 750-frame context","3. Moshi voice replay · 20 sec","4. Compare CPU/GPU codec · all four routes"}));column.addView(voice);
