...
final class ModelStore {
    ...
    boolean ready()throws Exception{
        ...
        return new File(root,"reference.wav").length()>44;
    }
    void install(Uri folder,Progress progress)throws Exception{
        ...
        try(InputStream in=context.getAssets().open("reference.wav")){Files.copy(in,new File(root,"reference.wav").toPath(),StandardCopyOption.REPLACE_EXISTING);}
